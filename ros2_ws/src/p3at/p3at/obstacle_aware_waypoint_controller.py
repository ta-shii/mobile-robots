...
class ObstacleAwareWaypointController(Node):
    def __init__(self):
        super().__init__('obstacle_aware_waypoint_controller')
        ...
        # Latest front obstacle distance
        ...
        self.get_logger().info(
            f'Obstacle-aware waypoint controller started with {len(self.waypoints)} waypoints.'
        )
    ...
    def control_loop(self):
        ...
        # ----- Obstacle avoidance comes first -----
...
def main(args=None):
    ...
    node = ObstacleAwareWaypointController()
    rclpy.spin(node)
    node.destroy_node()
    rclpy.shutdown()
